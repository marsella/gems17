...
"NICE WORK! THE NEXT CLUE IS AT:
 SEAS.UPENN.EDU/~JPAYKIN/GEMS/AUTH.PDF"
...
TODO add clues.
\begin{enumerate}
  \item Get your next clue in Towne 100. (hash: 123456)
  \item Get your next clue at your grandmother's house. (hash: 349092)
  \item Get your next clue from Achala. (hash: 2032790601)
  \item Get your next clue from under your desk (hash: 4098245890)
\end{enumerate}
...
Today we'll try a different kind of algorithm. Describe how to create a butter and jelly sandwich. Write down the steps below. When you're satisfied with your algorithm, bring it to an instructor to check. Once your algorithm creates a standard sandwich, you will receive your next clue.
